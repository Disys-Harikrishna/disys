...
class Google_pay:                                                                               
    ...
    def PanCard(self):
        ...
        pan=input('enter your 10 character pan number')
        print('pannumber='+pan)
    ...
    def Bank_details(self):
        account_numb=input('enter the account nymber=')
        print('account number='+account_numb)
    ...
    def set_pin(self):
        pin=input('create 4 digit your pin=')
        zin=input('please enter your 4 digit pin')
        print('your pin='+pin)
        if (len(self.pin)<=4):
            print('your pin is successfully created')
            if(pin==zin):
                print('verified welcome,please cooperate in next step verification')
        else:
